...
@Autonomous(name="Auto Far Red 9 Tangent", group="Red")
public class AutoFarRed9A extends OpMode{
    ...
    public void buildPaths() {
        ...
        HeadingInterpolator grab = HeadingInterpolator.piecewise(
                ...
                new HeadingInterpolator.PiecewiseNode(
                        0.8,
                        1,
                        HeadingInterpolator.linear(Math.toRadians(360+180-160),grabPose.getHeading())
                )
        );
